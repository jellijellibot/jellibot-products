...
const included = [
  "Full Felix playbook condensed into a clear step-by-step guide",
  "Memory system setup (PARA ~/life/ structure)",
  "Tool access walkthrough: GitHub, Vercel, Stripe",
  "Heartbeat + cron job configuration",
  "First product launch checklist",
  "Security rules to keep your bot safe",
  "Real prompts and configs you can copy/paste",
];
    ...
    <main style={{ minHeight: "100vh", background: "linear-gradient(135deg, #080810 0%, #0d0d1a 100%)", padding: "60px 20px" }}>
      ...
      <div style={{ maxWidth: 720, margin: "0 auto", position: "relative", zIndex: 1 }}>
        ...
        <p style={{ fontSize: 18, color: "#94a3b8", lineHeight: 1.7, marginBottom: 48 }}>
          Nat Eliason gave his AI bot $1,000 and it built an $80K/yr business. This guide breaks down exactly how to replicate it — condensed, actionable, no fluff.
        </p>
        ...
        <div className="glass" style={{ padding: "40px", marginBottom: 32 }}>
          ...
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: 20 }}>
            <div>
              ...
              <div style={{ color: "#94a3b8", fontSize: 14 }}>One-time · PDF · Instant access</div>
            </div>
